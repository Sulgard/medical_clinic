...
public class PrescriptionsController {
    ...
    ResponseEntity<Prescription> createPrescription(@RequestBody CreatePrescriptionRequestDTO data) {
        Prescription response = prescriptionService.createPrescritpion(data);
